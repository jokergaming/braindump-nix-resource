...
- tags :: [[file:nixos.org][NixOS]], [[file:nixops.org][NixOps]], [[file:../guangtao's_learning_programming_languages.org][GuangTao's learning Programming languages]], [[file:nix_wiki.org][Nix Wiki]]
...
** Nix [[file:../programming/guangtao's_rust.org][GuangTao's Rust]]
:PROPERTIES:
...
** Nix [[file:../programming/guangtao's_python.org][GuangTao's Python]]
:PROPERTIES:
...
** Nix [[file:../programming/guangtao's_golang.org][GuangTao's Golang]]
:PROPERTIES:
...
_ [[file:guangtao's_haskell.org][GuangTao's Haskell]]
* Nix cross-compiling
...
_ [[file:../data_science/jupyter_data_science.org][Jupyter Data Science]]
